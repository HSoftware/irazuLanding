import yrazu from "../../assets/images/Yrazu_con_fondo.jpg";
import "./Propuesta.css";

export default function PropuestaValor() {
  return (
    <section className="propuesta-valor">
      <h2 className="tituloPropuesta">
        Te guiará alguien que ya recorrió este camino
      </h2>
      ...
      <div className="emparejados">
        ...
        <div className="sobre-yrazu">
          ...
          <p className="py-3">
            ...
            objetivos claros y comunidad. Te acompaño con mentoría real,
            práctica y constante, porque aquí no caminas solo.
          </p>
          <ul className="listaPropuesta">
            <li className="itemListaPropuesta">
              <span className="iconoDorado">&#10003;</span>{" "}
              <span>Agente certificada</span>
            </li>
            <li className="itemListaPropuesta">
              <span className="iconoDorado">&#10003;</span>{" "}
              <span>Ingresos e historias reales</span>
            </li>
          </ul>
          <p>
